...
LANGUAGE_INSTRUCTION = 'put marker in cup'

# Modify to point to directory with raw DROID MP4 data
DATA_PATH = "/home/ashwinbalakrishna/kylehsu/code/fix-droid/droid/data/success/2024-08-12"
...
class DroidPutMarkerInCup(MultiThreadedDatasetBuilder):
